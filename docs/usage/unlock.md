# <code>mpox-seek <b>unlock</b></code>
...
This part of the documentation describes options and concepts for <code>mpox-seek <b>unlock</b></code> sub command in more detail. With minimal configuration, the **`unlock`** sub command enables you to unlock a pipeline output directory. 
...
Unlocking mpox-seek pipeline output directory is fast and easy! In its most basic form, <code>mpox-seek <b>unlock</b></code> only has *one required input*.
